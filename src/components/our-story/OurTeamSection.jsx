...
const OurTeamSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1320px] mx-auto bg-[#FBEADC] py-16 px-4">
        <div className="max-w-6xl mx-auto flex flex-col">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl mb-6 lg:mb-8 text-[#165620] text-start lg:text-center font-medium leading-tight uppercase">
            Our Team
          </h2>

...
const HouseDesignSection = () => {
  return (
    <section
      aria-labelledby="house-design-heading"
      className="my-16 sm:my-20 md:my-24 lg:px-8"
    >
      <div className="max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-[5fr_7fr] items-center">
        <figure className="relative -mt-36 sm:-mt-56 md:-mt-72 lg:mt-0">
          <img

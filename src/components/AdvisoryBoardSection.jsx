...
const AdvisoryBoardSection = () => {
  return (
    <section className="my-16">
      <div className="max-w-[1320px] mx-auto bg-[#165620] text-[#FBEADC] py-12 px-4">
        <div className="max-w-6xl mx-auto flex flex-col">
          <h2 className="text-6xl text-[#FBEADC] text-center font-extrabold leading-tight uppercase mb-8">
            Advisory Board
          </h2>
          ...
          <button className="bg-[#165620] border border-[#FFF6EE] uppercase text-white self-center flex gap-2 items-center justify-center py-3 px-8">
            <p>View All</p>
